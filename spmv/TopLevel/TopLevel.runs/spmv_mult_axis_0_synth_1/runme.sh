...
HD_PWD='/home/asiatici/epfl/memory-coalescer/vivado/spmv/spmv-hls/TopLevel/TopLevel.runs/spmv_mult_axis_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spmv_mult_axis_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spmv_mult_axis_0.tcl
