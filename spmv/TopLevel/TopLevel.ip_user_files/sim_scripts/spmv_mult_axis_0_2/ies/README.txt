...
#
# Generated by export_simulation on Wed Jul 04 10:36:31 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './spmv_mult_axis_0.sh' script.

./spmv_mult_axis_0.sh -reset_run
...
./spmv_mult_axis_0.sh -noclean_files

For more information on the script, please type './spmv_mult_axis_0.sh -help'.
