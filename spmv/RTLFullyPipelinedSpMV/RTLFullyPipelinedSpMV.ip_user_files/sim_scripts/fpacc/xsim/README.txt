...
#
# Generated by export_simulation on Fri Aug 31 18:33:38 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './fpacc.sh' script.
...
./fpacc.sh -noclean_files

For more information on the script, please type './fpacc.sh -help'.
