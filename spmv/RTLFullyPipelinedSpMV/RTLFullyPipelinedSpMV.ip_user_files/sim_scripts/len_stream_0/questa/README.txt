...
#
# Generated by export_simulation on Fri Aug 31 18:33:42 CEST 2018
#
################################################################################
...
'-reset_run' switch to the './len_stream_0.sh' script.

./len_stream_0.sh -reset_run
...
./len_stream_0.sh -noclean_files

For more information on the script, please type './len_stream_0.sh -help'.
